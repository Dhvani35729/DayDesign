    ...
    render() {
        if (Platform.OS == "android") {
            return (
                    ...
                    >
                    <Text style={styles.federationHallText}>
                    ...
                    >
                    <Text numberOfLines={1} style={styles.pmText}>
                    {tConvert(this.props.item.time)}
                    </Text>
                    </View>
                    </View>
                    </View>
                    ...
                    style={styles.tdInformationSessiText}
                    >
                    ...
                    {this.props.item.free_food && (
                                                   <Text style={styles.freeText}>Free Food</Text>
                                                   )}
                    </View>
            ...
            return (
                    ...
                    numberOfLines={2}
                    adjustsFontSizeToFit={true}
                    style={styles.tdInformationSessiTextIos}
                    >
                    {this.props.item.group_name}
                    </Text>
