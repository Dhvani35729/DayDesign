...
export default class App extends React.Component {
  ...
  componentDidMount() {
    ...
    AsyncStorage.getItem("alreadyLaunched4").then(value => {
            if(value == null){
                  Alert.alert(
  ...
  [
    {text: 'OK. I agree.', onPress: () => this.setState({firstLaunch: false, signedIn: false, checkedSignIn: true})},
  ],
  { cancelable: false }
)
                 AsyncStorage.setItem('alreadyLaunched3', 'I like to save it.');
